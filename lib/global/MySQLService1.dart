...
//=========================================================
  Future<String> chkLogin(String uid, String pwd) async {
    String url = "http://$ipAddress/phpFlutter/FlutterLogin.php/";
...
//=========================================================
  Future<String> CheckTokenExpireBearer(String token) async {
    //bool status;
    //String data = "";
    var ret;
    ...
    return ret;
    //ret = {"status": status};
    //var ret = {"status": status, "token": token, "data": data};
    //return json.encode(ret);
    //return ret.toString();
  }
