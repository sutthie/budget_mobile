...
class test_url_launcher1 extends StatefulWidget {
  const test_url_launcher1({super.key});

  @override
  State<test_url_launcher1> createState() => _test_url_launcher1State();
}

class _test_url_launcher1State extends State<test_url_launcher1> {
